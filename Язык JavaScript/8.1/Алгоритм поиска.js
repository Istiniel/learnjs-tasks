...
// При первом вызове быстрее через pockets.glasses, т.к. отпадает необходимость искать данное свойство по цепочке прототипов. Но если использовать данные аттрибут повторно, движок запомнит ссылку и разницы в скорости не будет
